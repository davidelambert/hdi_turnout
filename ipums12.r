...
# import & back up
ddi <- read_ipums_ddi("sources/ipums/usa_00006.xml")
data12 <- read_ipums_micro(ddi)
data12_bu <- data12

# check out
str(data12)
View(data12[sample(1:3113030, 12, replace = F), ])
...
# sample -- looks good
View(recode[sample(1:3113030, 12, replace = F), ])
...
save(state, file = "ipums12.Rdata")
write_csv(state, "ipums12.csv")
