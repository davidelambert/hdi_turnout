...
# import & back up
ddi <- read_ipums_ddi("sources/ipums/usa_00005.xml")
data08 <- read_ipums_micro(ddi)
data08_bu <- data08

# check out
str(data08)
View(data08[sample(1:nrow(data08) , 12, replace = F), ])
...
save(state, file = "ipums08.Rdata")
write_csv(state, "ipums08.csv")
