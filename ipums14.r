...
# import & back up
ddi <- read_ipums_ddi("sources/ipums/usa_00007.xml")
data14 <- read_ipums_micro(ddi)
data14_bu <- data14

# check out
str(data14)
View(data14[sample(1:3132610, 12, replace = F), ])
...
# sample -- looks good
View(recode[sample(1:3132610, 12, replace = F), ])
...
save(state, file = "ipums14.Rdata")
write_csv(state, "ipums14.csv")
